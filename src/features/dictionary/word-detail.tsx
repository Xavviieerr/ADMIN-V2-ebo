...
import {
  ...
  TranslationList,
  WordDetailSection,
} from "./word-detail/index";
import { SingleWordSenseProvider } from "./word-detail/contexts/SingleWordSenseContext";
...
import {
  ReviewListWrapper,
  SenseListWrapper,
} from "./word-detail/wrappers";
import { DeleteWordButton } from "./word-detail/buttons";
    ...
    <SingleWordSenseProvider>
      ...
      <div className="min-h-screen p-3 sm:p-4 md:p-6 lg:p-8 text-white">
        ...
        <div className="dark-box w-full py-10 px-5">
          ...
          <SenseListWrapper sensesCount={data.oho.length}>
            <SensesList senses={data.oho} />
          </SenseListWrapper>

          <TabGate condition="translations">
