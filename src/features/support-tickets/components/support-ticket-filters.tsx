...
export default function SupportTicketFilters({
  ...
  const displaySortDirLabel = currentSortDirLabel ? t(currentSortDirLabel.labelKey) : sortDir;
    ...
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
      ...
      <div className="relative" ref={categoryDropdownRef}>
        ...
        >
          ...
          <ChevronDown className={`h-4 w-4 shrink-0 transition-transform ${categoryDropdownOpen ? "rotate-180" : ""}`} />
        </button>
      ...
      <div className="relative" ref={sortDropdownRef}>
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm truncate">{displaySortDirLabel}</span>
          </div>
          {getSortIcon()}
        </button>
        {sortDropdownOpen && (
