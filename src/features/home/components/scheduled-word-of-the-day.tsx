...
const ScheduledWordOfTheDay = ({
  ...
  data: HomeStats["scheduledWords"] | undefined;
}) => {
          ...
          {data.map((word) => (
            ...
            >
              <div className="flex items-center gap-4">
                <div className={`rounded-full  w-3 h-3 bg-amber-600`} aria-label="Scheduled word status" />
              ...
              <div className="flex flex-col items-end gap-2 text-gray-txt">
                <span className="text-gray-txt-50 text-xs italic">
                  {word.isPublished ? t("home.published") : t("home.notPublished")}
                </span>
              </div>
            </li>
          ))}
