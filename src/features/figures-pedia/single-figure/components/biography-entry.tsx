...
const BiographyEntry = ({
  ...
  entry: Figure["biography"][number]["entries"][number];
}) => {
    ...
    <div className="flex flex-col w-full">
      ...
      {open && (
        <div className="w-full mt-5">
          {mainImage && (
            <div className="flex max-md:w-full flex-col md:float-left md:mr-5 gap-y-3">
              <Image
                src={mainImage}
                alt={entry.title}
                width={256}
          ...
          <p className="w-full text-sm text-justify max-md:pt-4 whitespace-pre-wrap">
            {entry.content}
          </p>
